...
The documentation, including this report, is generated by Doxygen and is provided in PDF and HTML format under the `docs` folder with the folowing filename: `Documentation`.
