/** \file
 * \brief Handles the kobjects for the session manager, part of the _Session Information_ submodule.
 ...
 * \param[in] session the information on the session to be removed, represented by a struct `::sess_info`.
 */
